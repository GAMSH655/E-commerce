...
function Flash() {
  ...
  const Items = [
    { id: 1, img: Game, itemTag: "HAVIT HV-G92 Gamepad", itemPrice: 120 },
    { id: 2, img: Keyboard, itemTag: "AK-900 Wired Keyboard", itemPrice: 180 },
    { id: 3, img: Tv, itemTag: "IPS LCD Gaming Monitor", itemPrice: 500 },
    { id: 4, img: Chair, itemTag: "S-Series Comfort Chair ", itemPrice: 600 },
  ];
    ...
    <div>
      ...
      <div className="flashcontainer">
        ...
        <div className="timeContainer">
          <p className="time">
            days <span className="span">03 :</span>
          </p>
          <p className="time">
            hours <span className="span">23 :</span>
          </p>
          <p className="time">
            minutes<span className="span">19 :</span>
          </p>
          <p className="time">
            seconds <span className="span">56 </span>
          </p>
        </div>
        ...
        {Items.map((goodd, index) => {
          return (
            <div key={index} className="eachItem">
              ...
              <Star />
              <button className="buy" onClick={() => AddCartBtn(goodd)}>
                add to cart
              </button>
            </div>
          );
